...
public class Practice {
    ...
    public static Region getRegionOfITDepartment() throws Exception {
        ...
        return departmentService.readAll().stream()
                ...
                .findFirst().orElseThrow(()->new Exception("can't find any region which is department name equal IT"));
...
//                .collect(Collectors.toList());
    ...
    public static Job getMaxSalaryEmployeeJob() throws Exception {
        ...
        return employeeService.readAll().stream()
                .max(Comparator.comparing(Employee::getSalary))
                .orElseThrow(Exception::new).getJob();
    }
    ...
    public static Long getMaxSalaryInAmericasRegion() throws Exception {
        ...
        return employeeService.readAll().stream()
                ...
                .max(Comparator.comparing(Employee::getSalary))
                .stream().findFirst().orElseThrow().getSalary();
    }
    ...
    public static List<Employee> getMinSalaryEmployee() {
        ...
        return employeeService.readAll().stream()
                .filter(employee -> {
                    try {
                        return employee.getSalary()==getMinSalary();
                    } catch (Exception e) {
                        throw new RuntimeException(e);
                    }
                })
    ...
    public static List<Employee> getSecondMinSalaryEmployee() {
        ...
        return employeeService.readAll().stream()
                .filter(employee -> {
                    try {
                        return Objects.equals(employee.getSalary(), getSecondMinSalary());
                    } catch (Exception e) {
                        throw new RuntimeException(e);
                    }
                })
    ...
    public static List<String> getAllEmployeesInitials() {
        ...
        return employeeService.readAll().stream()
                .map(employee -> {
                    ...
                    String secondInitials = employee.getLastName().substring(0,1);
